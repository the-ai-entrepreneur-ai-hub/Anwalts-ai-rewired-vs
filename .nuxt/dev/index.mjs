...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getHeader, setCookie, getCookie, readMultipartFormData, setHeader, getResponseStatusText } from 'file:///root/anwalts-frontend-new/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///root/anwalts-frontend-new/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///root/anwalts-frontend-new/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///root/anwalts-frontend-new/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///root/anwalts-frontend-new/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///root/anwalts-frontend-new/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///root/anwalts-frontend-new/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///root/anwalts-frontend-new/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///root/anwalts-frontend-new/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///root/anwalts-frontend-new/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///root/anwalts-frontend-new/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///root/anwalts-frontend-new/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///root/anwalts-frontend-new/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///root/anwalts-frontend-new/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///root/anwalts-frontend-new/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///root/anwalts-frontend-new/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///root/anwalts-frontend-new/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///root/anwalts-frontend-new/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///root/anwalts-frontend-new/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///root/anwalts-frontend-new/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///root/anwalts-frontend-new/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///root/anwalts-frontend-new/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///root/anwalts-frontend-new/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///root/anwalts-frontend-new/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///root/anwalts-frontend-new/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///root/anwalts-frontend-new/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///root/anwalts-frontend-new/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///root/anwalts-frontend-new/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///root/anwalts-frontend-new/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/root/anwalts-frontend-new/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/root/anwalts-frontend-new","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/root/anwalts-frontend-new/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/root/anwalts-frontend-new/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/root/anwalts-frontend-new/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/root/anwalts-frontend-new/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "backendBase": "http://172.19.0.4:8000",
...
const _DHxAYOKpzAWhTjFz_hdeJGdizX7kDQkwdoEsekqsSIg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/root/anwalts-frontend-new";
...
const _ZVLRDIpW9GpM8HYsqWyQk0sDVcy9cFZrTycrAVZCdL8 = (nitroApp) => {
...
const plugins = [
  _DHxAYOKpzAWhTjFz_hdeJGdizX7kDQkwdoEsekqsSIg,
_ZVLRDIpW9GpM8HYsqWyQk0sDVcy9cFZrTycrAVZCdL8,
...
const getServerEntry = () => import('file:///root/anwalts-frontend-new/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///root/anwalts-frontend-new/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_RwCrOC = () => Promise.resolve().then(function () { return google_get$1; });
const _lazy_x9qfoi = () => Promise.resolve().then(function () { return callback_get$1; });
const _lazy_V_Sx18 = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_THZ0Z_ = () => Promise.resolve().then(function () { return logout_get$1; });
const _lazy_AMdnZf = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_GwGTVQ = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_eMUJqv = () => Promise.resolve().then(function () { return postAuth_get$3; });
const _lazy_kigcon = () => Promise.resolve().then(function () { return proxyUpload_post$1; });
const _lazy_29Z6St = () => Promise.resolve().then(function () { return proxy_get$1; });
const _lazy_dUvpJG = () => Promise.resolve().then(function () { return proxy_post$1; });
const _lazy_odiNCE = () => Promise.resolve().then(function () { return test_get$1; });
const _lazy_Y4cRWI = () => Promise.resolve().then(function () { return users_get$1; });
const _lazy_Vf9Buj = () => Promise.resolve().then(function () { return log_post$1; });
const _lazy_oKRLwI = () => Promise.resolve().then(function () { return postAuth_get$1; });
const _lazy_b2aUPV = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/_fonts/**', handler: _lazy_b2aUPV, lazy: true, middleware: false, method: undefined },
...
const login_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const config = useRuntimeConfig();
    const backendBase = config.backendBase || process.env.BACKEND_BASE || "http://172.19.0.4:8000";
...
const me_get = defineEventHandler(async (event) => {
  try {
    ...
    if (authToken) {
      const config = useRuntimeConfig();
      const base = config.backendBase || process.env.BACKEND_BASE || "http://172.19.0.4:8000";
...
const postAuth_get$2 = defineEventHandler(async (event) => {
  var _a;
  const next = ((_a = getQuery$1(event)) == null ? void 0 : _a.next) || "/dashboard";
...
const postAuth_get$3 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: postAuth_get$2
}, Symbol.toStringTag, { value: 'Module' }));
...
const proxyUpload_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: proxyUpload_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const proxy_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: proxy_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const log_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: log_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const postAuth_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: postAuth_get
}, Symbol.toStringTag, { value: 'Module' }));

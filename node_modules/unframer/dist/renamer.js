...
const traverse_node_1 = require("@babel/traverse/lib/traverse-node");
...
class BatchRenamer {
    ...
    maybeConvertFromExportDeclaration(parentDeclar) {
        ...
        (0, helper_split_export_declaration_1.default)(maybeExportDeclar);
    }
    ...
    rename( /* Babel 7 - block?: t.Pattern | t.Scopable */) {
        ...
        (0, traverse_node_1.traverseNode)(scope.block, traverse_1.visitors.explode(renameVisitor), scope, this, scope.path, 
